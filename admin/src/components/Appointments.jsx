    ...
    <div className="outfit bg-[#FFFFFF] overflow-hidden ml-3 mr-3 sm:ml-10 py-4 rounded-lg">
      ...
      <div>
        ...
        {dashboard?.latestAppointments?.map((item) => {
          const docData = item.docData ? safeParseJSON(item.docData) : {};
          const userData = item.userData ? safeParseJSON(item.userData) : {};
          return (
            <div>
              <div className="flex pl-2 sm:pl-4 flex-row justify-between items-center mr-2 sm:mr-7 mt-5">
                <div>
                  <img
                    src="https://imgs.search.brave.com/yywpmDr_FXw8yk9jrmF_-AW6fJ2u0F-K96zHjyEh5bo/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/ZnJlZS1waG90by9m/ZW1hbGUtZG9jdG9y/LWhvc3BpdGFsXzIz/LTIxNDg4Mjc3NjAu/anBnP3NlbXQ9YWlz/X2h5YnJpZA"
